...
class PrivacyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var html: String = "<body><h2>Privacy Policy</h2> <p> Manoel Afonso dos Santos Neto built the DigiColle app as a Free app. This SERVICE is provided by Manoel Afonso dos Santos Neto at no cost and is intended for use as is.\n" +
                ...
                "                    at DigiColle unless otherwise defined in this Privacy Policy.\n" +
                "                  </p> <p><strong>Information Collection and Use</strong></p> <p>For a better experience, while using our Service, I may require you to provide us with certain\n" +
                "                    personally identifiable information, including but not limited to SIM Card Serial Number. The information that I request is retained on your device and is not collected by me in any way\n" +
        ...
        txtPrivacy.text = Html.fromHtml(html)
    }
